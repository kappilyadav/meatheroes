<?php
  $role = [
    ["text"=> "Analyze payroll integration requirements in a SaaS HCM implementation Design, implement and test integration of payroll processes and technical integration"],
  ...
  $aboutYou = [
    ["text"=> "Hands-on experience and certification in SuccessFactors, Workday or Oracle HCM"],
    ["text"=> "Experienced in implementing payroll solutions, ideally in multiple countries"],
  ];
?>
<?php get_header(); ?>
    ...
    <section class="container py-12">
        <p class="heading text-center md:text-left">BUSINESS ANALYST PAYROLL INTEGRATION</p>
        <div class="flex justify-center md:justify-start">
            <p class="border-b-2 border-blue w-24 mt-5"></p>
        </div>
        <p class="text-center md:text-left py-12">1phi618 is always looking for talented people to become its team members. We realize that productive people are always an asset to our organization. So if you have the professional skills and the passion to work with some of the biggest companies in the world, join in!</p>
